...
public class ExceptionController {
    ...
    public JsonResponse serviceExceptionHandler(HttpMessageNotReadableException e) {
        log.error("error", e);
        return JsonResponse.error("前端提交參數解析失敗", 406);
    }
